...
public class Valid {
    ...
    public static void checkBoolean(final boolean condition, final String... errorMessage) {
        if (!condition) {
            throw new LightningValidationException(errorMessage);
        }
    }

    public static <T> void notNull(@Nullable final T object, @Nullable final String... message) {
        if (object != null) {
            return;
        }
